...
{
	m_uShaderProgramID = LoadShaders("Shaders//BasicColor.vs", "Shaders//BasicColorInverted.fs");
...
void AppClass::Display(void)
{
	...
	GLuint Comp = glGetUniformLocation(m_uShaderProgramID, "Comp");
	glUniform1i(Comp, m_bComp);
